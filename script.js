...
const e_download_kicad_href = os == 'windows' ? 'https://downloads.kicad.org/kicad/windows/explore/nightlies'
  ...
  : null;
const e_download_kicad_wakatime_href = os == 'windows' ? 'https://github.com/hackclub/kicad-wakatime/releases/download/0.2.1/kicad-wakatime-0.2.1-windows.zip'
  : os == 'macos' ? 'https://github.com/hackclub/kicad-wakatime/releases/download/0.2.1/kicad-wakatime-0.2.1-macos.zip'
  : os == 'linux' ? 'https://github.com/hackclub/kicad-wakatime/releases/download/0.2.1/kicad-wakatime-0.2.1-linux.zip'
  : 'https://github.com/hackclub/kicad-wakatime/releases/tag/0.2.1'
